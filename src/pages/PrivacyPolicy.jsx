...
const SECTIONS = [
  {
    ...
    content: `1Market.ph ("we", "our", "us") is committed to protecting the privacy and personal data of all users of this website. This Privacy Policy explains how we collect, use, store, and protect your information in full compliance with the Philippine Data Privacy Act of 2012 (Republic Act No. 10173) and its Implementing Rules and Regulations.

By accessing or using 1Market.ph, you acknowledge that you have read, understood, and agree to the terms of this Privacy Policy.

Note: 1Market.ph is a community marketplace platform currently in its early operational stage. We are committed to registering with the relevant Philippine government agencies (DTI/SEC) as we grow.`,
  },
  {
    icon: '📦',
...
• Creating and managing your 1Market.ph account
...
Despite our best efforts, no online system is 100% immune to risk. We encourage you to use a strong, unique password for your 1Market.ph account.`,
  },
  {
    icon: '⚖️',
...
To exercise any of these rights, contact us at: privacy@1market.ph`,
  },
  {
    icon: '🍪',
    title: '6. Cookies & Tracking',
    content: `1Market.ph uses minimal, functional cookies only:
...
You may disable cookies in your browser settings, though some site functionality may be affected.`,
  },
  {
    ...
    content: `1Market.ph contains links to external business websites, social media pages, and booking platforms (e.g., hotel booking sites, brand stores). These third-party sites have their own privacy policies which we do not control. We encourage you to review the privacy policies of any external site you visit through our platform.`,
  },
  {
    icon: '👶',
    title: '8. Children\'s Privacy',
    content: `1Market.ph is not directed at children under the age of 18. We do not knowingly collect personal data from minors. If you believe a minor has submitted personal information through our platform, please contact us immediately and we will delete it promptly.`,
  },
  {
    icon: '📝',
    title: '9. Policy Updates',
    content: `We may update this Privacy Policy from time to time to reflect changes in our practices or applicable law. We will notify registered users of significant changes via email. Continued use of 1Market.ph after the effective date of changes constitutes your acceptance of the updated policy. The date of last update is shown at the bottom of this page.`,
  },
  {
    icon: '📧',
...
1Market.ph Data Privacy Office
Founder: Kevin W. Roberto
Email: privacy@1market.ph
    ...
    <div className="min-h-screen bg-[#F8FAFC]">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="font-body text-xs tracking-[0.2em] uppercase text-[#00D4FF] mb-0.5">1Market.ph</p>
            ...
            <p className="font-body text-sm text-white/50 max-w-2xl leading-relaxed">
              Your privacy is our priority. This policy explains how 1Market.ph collects, uses, and protects your personal information in compliance with the Philippine Data Privacy Act of 2012 (RA 10173).
            </p>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-6">
        ...
        <div className="text-center py-6">
          <p className="font-body text-xs text-[#0A192F]/30">Last updated: May 2026 · 1Market.ph · Manila, Philippines</p>
