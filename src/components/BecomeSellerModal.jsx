...
const FOOD_BUSINESS_TYPES = [
  ...
  { value: 'Restaurant / Resto Bar',    label: '🍽️ Restaurant / Resto Bar',   desc: 'Sit-down dining establishment' },
              ...
              {step === 'food_questions' && (
                <motion.div key="food" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="px-5 pb-6">
                  {foodStep === 0 ? (
                    ...
                    <>
                      <h2 className="font-heading font-bold text-xl text-white mb-1">🍽️ What food do you sell?</h2>
