...
const CATS = [
  ...
  { key: 'Flights',        icon: '', label: 'Flights',       color: '#0ea5e9' },
  { key: 'Ferry & Bus',    icon: '', label: 'Ferry & Bus',  color: '#8b5cf6' },
  { key: 'Car Rentals',    icon: '', label: 'Car Rentals',   color: '#ec4899' },
  { key: 'Van Rentals',    icon: '', label: 'Van Rentals',   color: '#f97316' },
  { key: 'Tours',          icon: '', label: 'Tours',         color: '#22c55e' },
  { key: 'Island Hopping', icon: '', label: 'Islands',       color: '#06b6d4' },
