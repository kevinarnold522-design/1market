...
export default function AIPhotoListingCreator({ onApplyListing }) {
  ...
  const handleFiles = async (e) => {
    ...
    try {
      ...
      setStatus('Scanning photos and generating your listing...');
      let draft;
      try {
      ...
      if (!draft.safe_to_list) setError(draft.moderation_notes || 'These images were flagged for review. You can edit them, but they will not auto-publish.');
    ...
    <div className="rounded-2xl p-4 space-y-3" style={{ background: 'linear-gradient(135deg,rgba(0,212,255,0.13),rgba(37,99,235,0.16))', border: '1px solid rgba(0,212,255,0.35)' }}>
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <p className="font-heading font-bold text-white text-sm">Create Listing from Photos</p>
