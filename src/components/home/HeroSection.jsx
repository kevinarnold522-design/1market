        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-screen py-24 lg:py-28">
          ...
          <motion.div
            ...
            <div className="space-y-5">
              ...
              <p className="font-body text-xs sm:text-sm text-[#0A192F]/40 max-w-sm leading-relaxed">Founded by Kevin Roberto in 2026 as bussiness that helps — a growing community thanks to you.
