    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-screen py-24 lg:py-28">
          ...
          {/* Right: Mascot Car Image - 30% Bigger */}
          <motion.div
            ...
            <img 
              ...
              className="w-full max-w-[3.25rem] sm:max-w-[6.5rem] lg:max-w-[7.8rem] drop-shadow-2xl"
              style={{ filter: 'drop-shadow(0 13px 26px rgba(0,212,255,0.2))' }}
            />
          </motion.div>
        </div>
      </div>
