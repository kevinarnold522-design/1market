...
export default function HeroSection({ heroImage }) {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Kinetic line decoration */}
      <motion.div
        className="absolute left-12 top-0 w-[1px] bg-gradient-to-b from-transparent via-[#00D4FF] to-transparent"
        initial={{ height: 0 }}
        animate={{ height: '100%' }}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-screen py-28">
          ...
          >
            <div className="space-y-6">
              ...
              <h1 className="font-heading font-bold leading-[0.95] tracking-tight">
                <span className="block text-5xl sm:text-6xl lg:text-7xl xl:text-8xl text-[#0A192F]">
                  Welcome to
                </span>
                <span className="block text-5xl sm:text-6xl lg:text-7xl xl:text-8xl text-[#2563EB] mt-2">
                  1 Market
                </span>
              </h1>

              <p className="font-body text-base sm:text-lg text-[#0A192F]/60 max-w-md leading-relaxed">
                We connect consumers to products and Businesses to the right people.
              </p>

              <div className="h-[1px] w-16 bg-[#00D4FF]" />

              <p className="font-body text-sm text-[#0A192F]/40 max-w-sm leading-relaxed">
                Founded by Kevin Roberto in 2026 — a growing business thanks to you.
              </p>
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 bg-white/90 backdrop-blur-xl rounded-xl shadow-xl shadow-[#0A192F]/5 px-6 py-4 border border-white/50"
            >
              <p className="font-heading font-bold text-2xl text-[#0A192F]">3</p>
              <p className="font-body text-xs text-[#0A192F]/50 tracking-wide">Categories</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
