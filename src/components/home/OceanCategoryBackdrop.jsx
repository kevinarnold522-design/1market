...
const fish = [
  { label: 'golden trevally 1', top: '66%', body: '#D6A83E', belly: '#F8E7B0', stripe: '#7C5A1A', fin: '#C7782A', duration: 13, delay: 0, dir: 1, size: 0.52 },
  { label: 'red snapper 1', top: '72%', body: '#B94A3A', belly: '#F5C7B8', stripe: '#7A241D', fin: '#D86E4D', duration: 15, delay: 0.4, dir: -1, size: 0.5 },
  { label: 'silver milkfish 1', top: '78%', body: '#C7D7DD', belly: '#F8FAFC', stripe: '#6C8792', fin: '#A7C0CA', duration: 16, delay: 0.8, dir: 1, size: 0.58 },
  { label: 'blue tang 1', top: '84%', body: '#2E6FAE', belly: '#8FC6E8', stripe: '#123A66', fin: '#F0C94B', duration: 14, delay: 1.2, dir: -1, size: 0.46 },
  { label: 'clownfish 1', top: '90%', body: '#F97316', belly: '#FFE1B8', stripe: '#FFFFFF', fin: '#EF4444', duration: 12, delay: 1.6, dir: 1, size: 0.4 },
  { label: 'parrotfish 1', top: '69%', body: '#18A999', belly: '#BFF7EA', stripe: '#146C94', fin: '#FACC15', duration: 17, delay: 2, dir: -1, size: 0.48 },
  { label: 'yellowfin tuna 1', top: '76%', body: '#426B8A', belly: '#EDF7FA', stripe: '#1E3A5F', fin: '#FACC15', duration: 11, delay: 2.4, dir: 1, size: 0.44 },
  { label: 'reef fish 1', top: '88%', body: '#7C3AED', belly: '#DDD6FE', stripe: '#FBBF24', fin: '#FB7185', duration: 13, delay: 2.8, dir: -1, size: 0.38 },
  { label: 'golden trevally 2', top: '81%', body: '#D6A83E', belly: '#F8E7B0', stripe: '#7C5A1A', fin: '#C7782A', duration: 18, delay: 3.2, dir: 1, size: 0.36 },
  { label: 'silver milkfish 2', top: '93%', body: '#C7D7DD', belly: '#F8FAFC', stripe: '#6C8792', fin: '#A7C0CA', duration: 14, delay: 3.6, dir: -1, size: 0.42 },
];
...
function OceanWaves() {
  const layers = [
    { bottom: '0%', height: 96, color: 'rgba(29,78,216,0.52)', duration: 4.2 },
    { bottom: '13%', height: 86, color: 'rgba(14,165,233,0.36)', duration: 5.1 },
    { bottom: '26%', height: 72, color: 'rgba(255,255,255,0.18)', duration: 6 }
  ];
  ...
  return (
    <div className="relative" style={{ width: 132 * item.size, height: 66 * item.size }}>
      <motion.svg
        ...
        <motion.path d="M24 33 L5 14 C16 19 23 24 27 31 C23 39 16 47 5 52 Z" fill={item.fin} opacity="0.9" animate={{ rotate: [-8, 10, -8] }} style={{ transformOrigin: '24px 33px' }} transition={{ duration: 0.45, repeat: Infinity, ease: 'easeInOut' }} />
