...
const HOTELS = [
  {
    id: 1, name: 'The Manila Hotel', location: 'Rizal Park, Manila', stars: 5, tag: 'Heritage Icon',
  ...
  {
    id: 3, name: 'Canyon Cove Hotel & Spa', location: 'Nasugbu, Cavite', stars: 4, tag: 'Beach Resort',
  ...
  {
    id: 6, name: 'Citystate Tower Hotel', location: 'Ermita, Manila', stars: 4, tag: 'City Center',
