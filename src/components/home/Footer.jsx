      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-24">
        <div className="grid md:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              <Link to="/about" className="block font-body text-xs text-white/20 hover:text-[#00D4FF] transition-colors">About Us</Link>
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-body text-xs text-white/30">
            © 2026 1Marketph.com. All rights reserved. · <Link to="/about" className="hover:text-[#00D4FF] transition-colors mr-2">About</Link> · <Link to="/privacy-policy" className="hover:text-[#00D4FF] transition-colors">Privacy Policy</Link>
          </p>
