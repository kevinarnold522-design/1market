...
const INTERESTS = [
  { key: 'traveller', label: 'Traveller', desc: 'Hotels, flights, tours & rentals' },
  { key: 'food', label: 'Food Lover', desc: 'Restaurants, carinderias & home kitchens' },
  { key: 'shopper', label: 'Shopper', desc: 'Electronics, clothing & gadgets' },
            ...
            {step === 1 && (
              <motion.div key="step1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-4">
                ...
                <div className="space-y-2">
                  {[
                    { key: 'customer', label: 'Customer Account', desc: 'Browse, save, rate & buy products, food, and services.' },
